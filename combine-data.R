...
write.csv(melb_df, "data/data_clean/melbourne_clean.csv")
...
write.table(melb_df, "data/data_clean/oxford_clean.txt")
...
write.table(x = plot_df,
            file = "data/data_processed/average-rainfall.csv",
            sep = ",",
            row.names = FALSE)
